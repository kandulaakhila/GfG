<h2><a href="https://www.geeksforgeeks.org/problems/remove-invalid-parentheses/1?_gl=1*1li2249*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwk_bPBhDXARIsACiq8R3nHISP8mDrczf6bn04hrzmqp2kC360hkkmTGZX3jSkzfhYS5nVaTcaAoF-EALw_wcB&gbraid=0AAAAAC9yBkDAmdqjhX0EUTlg8TczT-pzW">Remove Invalid Parentheses</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a string <strong>s</strong> consisting of lowercase letters and parentheses '(' and ')'.</span></p>
